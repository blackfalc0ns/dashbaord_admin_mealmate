# F130 — Spec After Fixes

## Purpose
تنفيذ **Audit Logs Viewer** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/audit_logs_viewer` | List/search |
| GET | `/api/v1/audit_logs_viewer/{id}` | Details |
| POST | `/api/v1/audit_logs_viewer` | Create/request |
| PUT | `/api/v1/audit_logs_viewer/{id}` | Update |
| POST | `/api/v1/audit_logs_viewer/{id}/actions/{action}` | State transition |
