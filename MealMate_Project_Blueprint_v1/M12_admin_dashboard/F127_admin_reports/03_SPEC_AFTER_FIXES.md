# F127 — Spec After Fixes

## Purpose
تنفيذ **Admin Reports** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/admin_reports` | List/search |
| GET | `/api/v1/admin_reports/{id}` | Details |
| POST | `/api/v1/admin_reports` | Create/request |
| PUT | `/api/v1/admin_reports/{id}` | Update |
| POST | `/api/v1/admin_reports/{id}/actions/{action}` | State transition |
