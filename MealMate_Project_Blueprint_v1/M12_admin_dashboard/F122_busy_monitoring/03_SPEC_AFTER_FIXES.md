# F122 — Spec After Fixes

## Purpose
تنفيذ **Busy Monitoring** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/busy_monitoring` | List/search |
| GET | `/api/v1/busy_monitoring/{id}` | Details |
| POST | `/api/v1/busy_monitoring` | Create/request |
| PUT | `/api/v1/busy_monitoring/{id}` | Update |
| POST | `/api/v1/busy_monitoring/{id}/actions/{action}` | State transition |
