# F128 — Spec After Fixes

## Purpose
تنفيذ **System Settings** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/system_settings` | List/search |
| GET | `/api/v1/system_settings/{id}` | Details |
| POST | `/api/v1/system_settings` | Create/request |
| PUT | `/api/v1/system_settings/{id}` | Update |
| POST | `/api/v1/system_settings/{id}/actions/{action}` | State transition |
