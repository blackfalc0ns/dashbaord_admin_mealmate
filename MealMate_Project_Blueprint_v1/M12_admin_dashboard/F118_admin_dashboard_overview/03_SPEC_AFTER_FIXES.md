# F118 — Spec After Fixes

## Purpose
تنفيذ **Admin Dashboard Overview** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/admin_dashboard_overview` | List/search |
| GET | `/api/v1/admin_dashboard_overview/{id}` | Details |
| POST | `/api/v1/admin_dashboard_overview` | Create/request |
| PUT | `/api/v1/admin_dashboard_overview/{id}` | Update |
| POST | `/api/v1/admin_dashboard_overview/{id}/actions/{action}` | State transition |
