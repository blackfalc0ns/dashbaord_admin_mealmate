# F129 — Spec After Fixes

## Purpose
تنفيذ **Roles & Permissions Administration** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/roles_permissions_administration` | List/search |
| GET | `/api/v1/roles_permissions_administration/{id}` | Details |
| POST | `/api/v1/roles_permissions_administration` | Create/request |
| PUT | `/api/v1/roles_permissions_administration/{id}` | Update |
| POST | `/api/v1/roles_permissions_administration/{id}/actions/{action}` | State transition |
