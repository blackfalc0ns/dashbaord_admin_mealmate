# F120 — Spec After Fixes

## Purpose
تنفيذ **Operations Monitoring** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/operations_monitoring` | List/search |
| GET | `/api/v1/operations_monitoring/{id}` | Details |
| POST | `/api/v1/operations_monitoring` | Create/request |
| PUT | `/api/v1/operations_monitoring/{id}` | Update |
| POST | `/api/v1/operations_monitoring/{id}/actions/{action}` | State transition |
