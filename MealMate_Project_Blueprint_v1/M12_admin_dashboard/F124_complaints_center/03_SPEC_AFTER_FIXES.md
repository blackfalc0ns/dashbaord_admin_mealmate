# F124 — Spec After Fixes

## Purpose
تنفيذ **Complaints Center** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/complaints_center` | List/search |
| GET | `/api/v1/complaints_center/{id}` | Details |
| POST | `/api/v1/complaints_center` | Create/request |
| PUT | `/api/v1/complaints_center/{id}` | Update |
| POST | `/api/v1/complaints_center/{id}/actions/{action}` | State transition |
