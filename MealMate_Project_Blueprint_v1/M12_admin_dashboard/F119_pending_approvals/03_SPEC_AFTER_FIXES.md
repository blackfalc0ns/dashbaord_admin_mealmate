# F119 — Spec After Fixes

## Purpose
تنفيذ **Pending Approvals** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/pending_approvals` | List/search |
| GET | `/api/v1/pending_approvals/{id}` | Details |
| POST | `/api/v1/pending_approvals` | Create/request |
| PUT | `/api/v1/pending_approvals/{id}` | Update |
| POST | `/api/v1/pending_approvals/{id}/actions/{action}` | State transition |
