# F132 — Spec After Fixes

## Purpose
تنفيذ **KPI Dashboard** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/kpi_dashboard` | List/search |
| GET | `/api/v1/kpi_dashboard/{id}` | Details |
| POST | `/api/v1/kpi_dashboard` | Create/request |
| PUT | `/api/v1/kpi_dashboard/{id}` | Update |
| POST | `/api/v1/kpi_dashboard/{id}/actions/{action}` | State transition |
