# F125 — Spec After Fixes

## Purpose
تنفيذ **Finance Dashboard** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/finance_dashboard` | List/search |
| GET | `/api/v1/finance_dashboard/{id}` | Details |
| POST | `/api/v1/finance_dashboard` | Create/request |
| PUT | `/api/v1/finance_dashboard/{id}` | Update |
| POST | `/api/v1/finance_dashboard/{id}/actions/{action}` | State transition |
