# F131 — Spec After Fixes

## Purpose
تنفيذ **Notifications Center** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/notifications_center` | List/search |
| GET | `/api/v1/notifications_center/{id}` | Details |
| POST | `/api/v1/notifications_center` | Create/request |
| PUT | `/api/v1/notifications_center/{id}` | Update |
| POST | `/api/v1/notifications_center/{id}/actions/{action}` | State transition |
