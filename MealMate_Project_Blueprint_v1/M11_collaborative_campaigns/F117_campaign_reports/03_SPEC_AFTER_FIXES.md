# F117 — Spec After Fixes

## Purpose
تنفيذ **Campaign Reports** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_reports` | List/search |
| GET | `/api/v1/campaign_reports/{id}` | Details |
| POST | `/api/v1/campaign_reports` | Create/request |
| PUT | `/api/v1/campaign_reports/{id}` | Update |
| POST | `/api/v1/campaign_reports/{id}/actions/{action}` | State transition |
