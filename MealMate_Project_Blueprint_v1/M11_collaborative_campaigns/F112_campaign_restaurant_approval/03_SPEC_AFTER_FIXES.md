# F112 — Spec After Fixes

## Purpose
تنفيذ **Campaign Restaurant Approval** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_restaurant_approval` | List/search |
| GET | `/api/v1/campaign_restaurant_approval/{id}` | Details |
| POST | `/api/v1/campaign_restaurant_approval` | Create/request |
| PUT | `/api/v1/campaign_restaurant_approval/{id}` | Update |
| POST | `/api/v1/campaign_restaurant_approval/{id}/actions/{action}` | State transition |
