...
2. **تفصيل API Contract**
   - إضافة schemas لكل endpoint:
     - `GET /api/v1/restaurant_campaign_capacity`
     - `GET /api/v1/restaurant_campaign_capacity/{id}`
     - `POST /api/v1/restaurant_campaign_capacity`
     - `PUT /api/v1/restaurant_campaign_capacity/{id}`
     - `POST /api/v1/restaurant_campaign_capacity/{id}/actions/{action}`
...
3. **تفصيل صلاحيات Role/Scope**
   - ربط كل شاشة وكل endpoint بصلاحية مثل `F109.View`, `F109.Create`, `F109.Update`, `F109.Override`.
