# F109 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Campaign Capacity** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_campaign_capacity` | List/search |
| GET | `/api/v1/restaurant_campaign_capacity/{id}` | Details |
| POST | `/api/v1/restaurant_campaign_capacity` | Create/request |
| PUT | `/api/v1/restaurant_campaign_capacity/{id}` | Update |
| POST | `/api/v1/restaurant_campaign_capacity/{id}/actions/{action}` | State transition |
