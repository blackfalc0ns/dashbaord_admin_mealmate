# F108 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Campaign Enrollment** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_campaign_enrollment` | List/search |
| GET | `/api/v1/restaurant_campaign_enrollment/{id}` | Details |
| POST | `/api/v1/restaurant_campaign_enrollment` | Create/request |
| PUT | `/api/v1/restaurant_campaign_enrollment/{id}` | Update |
| POST | `/api/v1/restaurant_campaign_enrollment/{id}/actions/{action}` | State transition |
