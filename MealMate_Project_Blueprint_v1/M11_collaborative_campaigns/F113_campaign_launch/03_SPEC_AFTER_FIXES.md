# F113 — Spec After Fixes

## Purpose
تنفيذ **Campaign Launch** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_launch` | List/search |
| GET | `/api/v1/campaign_launch/{id}` | Details |
| POST | `/api/v1/campaign_launch` | Create/request |
| PUT | `/api/v1/campaign_launch/{id}` | Update |
| POST | `/api/v1/campaign_launch/{id}/actions/{action}` | State transition |
