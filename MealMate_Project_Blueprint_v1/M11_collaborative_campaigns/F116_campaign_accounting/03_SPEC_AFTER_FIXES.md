# F116 — Spec After Fixes

## Purpose
تنفيذ **Campaign Accounting** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_accounting` | List/search |
| GET | `/api/v1/campaign_accounting/{id}` | Details |
| POST | `/api/v1/campaign_accounting` | Create/request |
| PUT | `/api/v1/campaign_accounting/{id}` | Update |
| POST | `/api/v1/campaign_accounting/{id}/actions/{action}` | State transition |
