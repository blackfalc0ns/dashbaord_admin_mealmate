# F104 — Spec After Fixes

## Purpose
تنفيذ **Campaign Discount Split** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_discount_split` | List/search |
| GET | `/api/v1/campaign_discount_split/{id}` | Details |
| POST | `/api/v1/campaign_discount_split` | Create/request |
| PUT | `/api/v1/campaign_discount_split/{id}` | Update |
| POST | `/api/v1/campaign_discount_split/{id}/actions/{action}` | State transition |
