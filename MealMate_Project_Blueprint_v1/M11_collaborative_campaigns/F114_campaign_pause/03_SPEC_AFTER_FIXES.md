# F114 — Spec After Fixes

## Purpose
تنفيذ **Campaign Pause** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_pause` | List/search |
| GET | `/api/v1/campaign_pause/{id}` | Details |
| POST | `/api/v1/campaign_pause` | Create/request |
| PUT | `/api/v1/campaign_pause/{id}` | Update |
| POST | `/api/v1/campaign_pause/{id}/actions/{action}` | State transition |
