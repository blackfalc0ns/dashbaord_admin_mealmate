# F105 — Spec After Fixes

## Purpose
تنفيذ **Campaign Programs** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_programs` | List/search |
| GET | `/api/v1/campaign_programs/{id}` | Details |
| POST | `/api/v1/campaign_programs` | Create/request |
| PUT | `/api/v1/campaign_programs/{id}` | Update |
| POST | `/api/v1/campaign_programs/{id}/actions/{action}` | State transition |
