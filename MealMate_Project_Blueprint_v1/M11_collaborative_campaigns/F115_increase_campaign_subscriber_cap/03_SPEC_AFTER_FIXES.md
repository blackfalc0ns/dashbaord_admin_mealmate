# F115 — Spec After Fixes

## Purpose
تنفيذ **Increase Campaign Subscriber Cap** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/increase_campaign_subscriber_cap` | List/search |
| GET | `/api/v1/increase_campaign_subscriber_cap/{id}` | Details |
| POST | `/api/v1/increase_campaign_subscriber_cap` | Create/request |
| PUT | `/api/v1/increase_campaign_subscriber_cap/{id}` | Update |
| POST | `/api/v1/increase_campaign_subscriber_cap/{id}/actions/{action}` | State transition |
