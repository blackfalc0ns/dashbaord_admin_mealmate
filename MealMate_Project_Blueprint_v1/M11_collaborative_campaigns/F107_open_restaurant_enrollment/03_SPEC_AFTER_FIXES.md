# F107 — Spec After Fixes

## Purpose
تنفيذ **Open Restaurant Enrollment** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/open_restaurant_enrollment` | List/search |
| GET | `/api/v1/open_restaurant_enrollment/{id}` | Details |
| POST | `/api/v1/open_restaurant_enrollment` | Create/request |
| PUT | `/api/v1/open_restaurant_enrollment/{id}` | Update |
| POST | `/api/v1/open_restaurant_enrollment/{id}/actions/{action}` | State transition |
