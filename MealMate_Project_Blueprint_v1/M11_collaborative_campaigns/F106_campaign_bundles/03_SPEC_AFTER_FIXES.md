# F106 — Spec After Fixes

## Purpose
تنفيذ **Campaign Bundles** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_bundles` | List/search |
| GET | `/api/v1/campaign_bundles/{id}` | Details |
| POST | `/api/v1/campaign_bundles` | Create/request |
| PUT | `/api/v1/campaign_bundles/{id}` | Update |
| POST | `/api/v1/campaign_bundles/{id}/actions/{action}` | State transition |
