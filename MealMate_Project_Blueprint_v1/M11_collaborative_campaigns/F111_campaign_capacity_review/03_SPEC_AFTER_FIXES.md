# F111 — Spec After Fixes

## Purpose
تنفيذ **Campaign Capacity Review** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_capacity_review` | List/search |
| GET | `/api/v1/campaign_capacity_review/{id}` | Details |
| POST | `/api/v1/campaign_capacity_review` | Create/request |
| PUT | `/api/v1/campaign_capacity_review/{id}` | Update |
| POST | `/api/v1/campaign_capacity_review/{id}/actions/{action}` | State transition |
