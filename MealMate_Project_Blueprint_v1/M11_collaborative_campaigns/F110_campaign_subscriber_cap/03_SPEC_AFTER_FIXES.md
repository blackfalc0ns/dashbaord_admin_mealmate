# F110 — Spec After Fixes

## Purpose
تنفيذ **Campaign Subscriber Cap** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/campaign_subscriber_cap` | List/search |
| GET | `/api/v1/campaign_subscriber_cap/{id}` | Details |
| POST | `/api/v1/campaign_subscriber_cap` | Create/request |
| PUT | `/api/v1/campaign_subscriber_cap/{id}` | Update |
| POST | `/api/v1/campaign_subscriber_cap/{id}/actions/{action}` | State transition |
