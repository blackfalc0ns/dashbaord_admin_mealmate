# F022 — Spec After Fixes

## Purpose
تنفيذ **72-Hour Lock Rule** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/72_hour_lock_rule` | List/search |
| GET | `/api/v1/72_hour_lock_rule/{id}` | Details |
| POST | `/api/v1/72_hour_lock_rule` | Create/request |
| PUT | `/api/v1/72_hour_lock_rule/{id}` | Update |
| POST | `/api/v1/72_hour_lock_rule/{id}/actions/{action}` | State transition |
