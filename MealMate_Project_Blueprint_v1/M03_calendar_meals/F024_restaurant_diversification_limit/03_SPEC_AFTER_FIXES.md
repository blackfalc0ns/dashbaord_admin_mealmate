# F024 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Diversification Limit** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_diversification_limit` | List/search |
| GET | `/api/v1/restaurant_diversification_limit/{id}` | Details |
| POST | `/api/v1/restaurant_diversification_limit` | Create/request |
| PUT | `/api/v1/restaurant_diversification_limit/{id}` | Update |
| POST | `/api/v1/restaurant_diversification_limit/{id}/actions/{action}` | State transition |
