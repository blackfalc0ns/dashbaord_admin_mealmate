# F027 — Spec After Fixes

## Purpose
تنفيذ **Subscription Freeze** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/subscription_freeze` | List/search |
| GET | `/api/v1/subscription_freeze/{id}` | Details |
| POST | `/api/v1/subscription_freeze` | Create/request |
| PUT | `/api/v1/subscription_freeze/{id}` | Update |
| POST | `/api/v1/subscription_freeze/{id}/actions/{action}` | State transition |
