# F023 — Spec After Fixes

## Purpose
تنفيذ **Automatic Selection** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/automatic_selection` | List/search |
| GET | `/api/v1/automatic_selection/{id}` | Details |
| POST | `/api/v1/automatic_selection` | Create/request |
| PUT | `/api/v1/automatic_selection/{id}` | Update |
| POST | `/api/v1/automatic_selection/{id}/actions/{action}` | State transition |
