# F025 — Spec After Fixes

## Purpose
تنفيذ **Allergies, Dislikes & Preferences** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/allergies_dislikes_preferences` | List/search |
| GET | `/api/v1/allergies_dislikes_preferences/{id}` | Details |
| POST | `/api/v1/allergies_dislikes_preferences` | Create/request |
| PUT | `/api/v1/allergies_dislikes_preferences/{id}` | Update |
| POST | `/api/v1/allergies_dislikes_preferences/{id}/actions/{action}` | State transition |
