# F026 — Spec After Fixes

## Purpose
تنفيذ **Meal Change Management** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/meal_change_management` | List/search |
| GET | `/api/v1/meal_change_management/{id}` | Details |
| POST | `/api/v1/meal_change_management` | Create/request |
| PUT | `/api/v1/meal_change_management/{id}` | Update |
| POST | `/api/v1/meal_change_management/{id}/actions/{action}` | State transition |
