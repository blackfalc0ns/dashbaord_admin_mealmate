# F019 — Spec After Fixes

## Purpose
تنفيذ **Subscription Calendar Generation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/subscription_calendar_generation` | List/search |
| GET | `/api/v1/subscription_calendar_generation/{id}` | Details |
| POST | `/api/v1/subscription_calendar_generation` | Create/request |
| PUT | `/api/v1/subscription_calendar_generation/{id}` | Update |
| POST | `/api/v1/subscription_calendar_generation/{id}/actions/{action}` | State transition |
