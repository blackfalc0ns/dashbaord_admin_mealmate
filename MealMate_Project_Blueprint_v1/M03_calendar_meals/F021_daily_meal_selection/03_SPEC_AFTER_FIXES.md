# F021 — Spec After Fixes

## Purpose
تنفيذ **Daily Meal Selection** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/daily_meal_selection` | List/search |
| GET | `/api/v1/daily_meal_selection/{id}` | Details |
| POST | `/api/v1/daily_meal_selection` | Create/request |
| PUT | `/api/v1/daily_meal_selection/{id}` | Update |
| POST | `/api/v1/daily_meal_selection/{id}/actions/{action}` | State transition |
