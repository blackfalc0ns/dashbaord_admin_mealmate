# F062 — Spec After Fixes

## Purpose
تنفيذ **Chart of Accounts** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/chart_of_accounts` | List/search |
| GET | `/api/v1/chart_of_accounts/{id}` | Details |
| POST | `/api/v1/chart_of_accounts` | Create/request |
| PUT | `/api/v1/chart_of_accounts/{id}` | Update |
| POST | `/api/v1/chart_of_accounts/{id}/actions/{action}` | State transition |
