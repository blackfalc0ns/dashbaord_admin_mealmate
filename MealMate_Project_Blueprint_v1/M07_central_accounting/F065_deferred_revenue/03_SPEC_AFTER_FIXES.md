# F065 — Spec After Fixes

## Purpose
تنفيذ **Deferred Revenue** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/deferred_revenue` | List/search |
| GET | `/api/v1/deferred_revenue/{id}` | Details |
| POST | `/api/v1/deferred_revenue` | Create/request |
| PUT | `/api/v1/deferred_revenue/{id}` | Update |
| POST | `/api/v1/deferred_revenue/{id}/actions/{action}` | State transition |
