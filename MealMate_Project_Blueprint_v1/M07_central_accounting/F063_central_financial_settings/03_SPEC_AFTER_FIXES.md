# F063 — Spec After Fixes

## Purpose
تنفيذ **Central Financial Settings** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/central_financial_settings` | List/search |
| GET | `/api/v1/central_financial_settings/{id}` | Details |
| POST | `/api/v1/central_financial_settings` | Create/request |
| PUT | `/api/v1/central_financial_settings/{id}` | Update |
| POST | `/api/v1/central_financial_settings/{id}/actions/{action}` | State transition |
