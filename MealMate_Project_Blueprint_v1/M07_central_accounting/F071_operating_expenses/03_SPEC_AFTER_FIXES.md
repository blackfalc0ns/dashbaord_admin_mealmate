# F071 — Spec After Fixes

## Purpose
تنفيذ **Operating Expenses** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/operating_expenses` | List/search |
| GET | `/api/v1/operating_expenses/{id}` | Details |
| POST | `/api/v1/operating_expenses` | Create/request |
| PUT | `/api/v1/operating_expenses/{id}` | Update |
| POST | `/api/v1/operating_expenses/{id}/actions/{action}` | State transition |
