# F069 — Spec After Fixes

## Purpose
تنفيذ **Payment Gateways** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/payment_gateways` | List/search |
| GET | `/api/v1/payment_gateways/{id}` | Details |
| POST | `/api/v1/payment_gateways` | Create/request |
| PUT | `/api/v1/payment_gateways/{id}` | Update |
| POST | `/api/v1/payment_gateways/{id}/actions/{action}` | State transition |
