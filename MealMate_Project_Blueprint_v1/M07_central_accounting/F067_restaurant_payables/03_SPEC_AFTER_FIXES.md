# F067 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Payables** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_payables` | List/search |
| GET | `/api/v1/restaurant_payables/{id}` | Details |
| POST | `/api/v1/restaurant_payables` | Create/request |
| PUT | `/api/v1/restaurant_payables/{id}` | Update |
| POST | `/api/v1/restaurant_payables/{id}/actions/{action}` | State transition |
