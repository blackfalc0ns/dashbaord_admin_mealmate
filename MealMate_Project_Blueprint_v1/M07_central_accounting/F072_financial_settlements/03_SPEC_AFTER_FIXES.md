# F072 — Spec After Fixes

## Purpose
تنفيذ **Financial Settlements** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/financial_settlements` | List/search |
| GET | `/api/v1/financial_settlements/{id}` | Details |
| POST | `/api/v1/financial_settlements` | Create/request |
| PUT | `/api/v1/financial_settlements/{id}` | Update |
| POST | `/api/v1/financial_settlements/{id}/actions/{action}` | State transition |
