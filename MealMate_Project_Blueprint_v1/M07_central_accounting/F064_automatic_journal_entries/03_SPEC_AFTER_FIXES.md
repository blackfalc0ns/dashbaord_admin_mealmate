# F064 — Spec After Fixes

## Purpose
تنفيذ **Automatic Journal Entries** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/automatic_journal_entries` | List/search |
| GET | `/api/v1/automatic_journal_entries/{id}` | Details |
| POST | `/api/v1/automatic_journal_entries` | Create/request |
| PUT | `/api/v1/automatic_journal_entries/{id}` | Update |
| POST | `/api/v1/automatic_journal_entries/{id}/actions/{action}` | State transition |
