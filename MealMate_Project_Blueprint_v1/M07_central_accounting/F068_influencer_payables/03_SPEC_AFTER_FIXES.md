# F068 — Spec After Fixes

## Purpose
تنفيذ **Influencer Payables** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/influencer_payables` | List/search |
| GET | `/api/v1/influencer_payables/{id}` | Details |
| POST | `/api/v1/influencer_payables` | Create/request |
| PUT | `/api/v1/influencer_payables/{id}` | Update |
| POST | `/api/v1/influencer_payables/{id}/actions/{action}` | State transition |
