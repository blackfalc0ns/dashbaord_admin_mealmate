# F070 — Spec After Fixes

## Purpose
تنفيذ **Taxes** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/taxes` | List/search |
| GET | `/api/v1/taxes/{id}` | Details |
| POST | `/api/v1/taxes` | Create/request |
| PUT | `/api/v1/taxes/{id}` | Update |
| POST | `/api/v1/taxes/{id}/actions/{action}` | State transition |
