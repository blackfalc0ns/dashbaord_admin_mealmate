# F031 — Spec After Fixes

## Purpose
تنفيذ **Daily Capacity Management** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/daily_capacity_management` | List/search |
| GET | `/api/v1/daily_capacity_management/{id}` | Details |
| POST | `/api/v1/daily_capacity_management` | Create/request |
| PUT | `/api/v1/daily_capacity_management/{id}` | Update |
| POST | `/api/v1/daily_capacity_management/{id}/actions/{action}` | State transition |
