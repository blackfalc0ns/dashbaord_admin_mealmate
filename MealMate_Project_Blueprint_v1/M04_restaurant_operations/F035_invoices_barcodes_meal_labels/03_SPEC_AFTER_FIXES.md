# F035 — Spec After Fixes

## Purpose
تنفيذ **Invoices, Barcodes & Meal Labels** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/invoices_barcodes_meal_labels` | List/search |
| GET | `/api/v1/invoices_barcodes_meal_labels/{id}` | Details |
| POST | `/api/v1/invoices_barcodes_meal_labels` | Create/request |
| PUT | `/api/v1/invoices_barcodes_meal_labels/{id}` | Update |
| POST | `/api/v1/invoices_barcodes_meal_labels/{id}/actions/{action}` | State transition |
