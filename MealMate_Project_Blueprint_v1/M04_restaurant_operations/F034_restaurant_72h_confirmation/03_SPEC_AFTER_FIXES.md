# F034 — Spec After Fixes

## Purpose
تنفيذ **Restaurant 72h Confirmation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_72h_confirmation` | List/search |
| GET | `/api/v1/restaurant_72h_confirmation/{id}` | Details |
| POST | `/api/v1/restaurant_72h_confirmation` | Create/request |
| PUT | `/api/v1/restaurant_72h_confirmation/{id}` | Update |
| POST | `/api/v1/restaurant_72h_confirmation/{id}/actions/{action}` | State transition |
