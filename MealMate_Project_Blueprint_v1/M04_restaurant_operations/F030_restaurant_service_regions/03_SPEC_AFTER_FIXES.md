# F030 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Service Regions** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_service_regions` | List/search |
| GET | `/api/v1/restaurant_service_regions/{id}` | Details |
| POST | `/api/v1/restaurant_service_regions` | Create/request |
| PUT | `/api/v1/restaurant_service_regions/{id}` | Update |
| POST | `/api/v1/restaurant_service_regions/{id}/actions/{action}` | State transition |
