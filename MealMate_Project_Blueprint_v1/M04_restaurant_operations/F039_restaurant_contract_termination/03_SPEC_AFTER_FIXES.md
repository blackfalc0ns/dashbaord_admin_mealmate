# F039 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Contract Termination** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_contract_termination` | List/search |
| GET | `/api/v1/restaurant_contract_termination/{id}` | Details |
| POST | `/api/v1/restaurant_contract_termination` | Create/request |
| PUT | `/api/v1/restaurant_contract_termination/{id}` | Update |
| POST | `/api/v1/restaurant_contract_termination/{id}/actions/{action}` | State transition |
