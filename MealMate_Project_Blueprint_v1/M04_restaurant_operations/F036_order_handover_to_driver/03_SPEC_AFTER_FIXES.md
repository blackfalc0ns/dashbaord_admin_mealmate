# F036 — Spec After Fixes

## Purpose
تنفيذ **Order Handover to Driver** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/order_handover_to_driver` | List/search |
| GET | `/api/v1/order_handover_to_driver/{id}` | Details |
| POST | `/api/v1/order_handover_to_driver` | Create/request |
| PUT | `/api/v1/order_handover_to_driver/{id}` | Update |
| POST | `/api/v1/order_handover_to_driver/{id}/actions/{action}` | State transition |
