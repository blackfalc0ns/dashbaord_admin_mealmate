# F028 — Spec After Fixes

## Purpose
تنفيذ **Menu & Meal Management** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/menu_meal_management` | List/search |
| GET | `/api/v1/menu_meal_management/{id}` | Details |
| POST | `/api/v1/menu_meal_management` | Create/request |
| PUT | `/api/v1/menu_meal_management/{id}` | Update |
| POST | `/api/v1/menu_meal_management/{id}/actions/{action}` | State transition |
