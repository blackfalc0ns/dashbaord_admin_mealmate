# F038 — Spec After Fixes

## Purpose
تنفيذ **Restaurant & Meal Ratings** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_meal_ratings` | List/search |
| GET | `/api/v1/restaurant_meal_ratings/{id}` | Details |
| POST | `/api/v1/restaurant_meal_ratings` | Create/request |
| PUT | `/api/v1/restaurant_meal_ratings/{id}` | Update |
| POST | `/api/v1/restaurant_meal_ratings/{id}/actions/{action}` | State transition |
