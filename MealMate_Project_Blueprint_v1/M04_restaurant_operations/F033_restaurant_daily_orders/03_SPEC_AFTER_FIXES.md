# F033 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Daily Orders** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_daily_orders` | List/search |
| GET | `/api/v1/restaurant_daily_orders/{id}` | Details |
| POST | `/api/v1/restaurant_daily_orders` | Create/request |
| PUT | `/api/v1/restaurant_daily_orders/{id}` | Update |
| POST | `/api/v1/restaurant_daily_orders/{id}/actions/{action}` | State transition |
