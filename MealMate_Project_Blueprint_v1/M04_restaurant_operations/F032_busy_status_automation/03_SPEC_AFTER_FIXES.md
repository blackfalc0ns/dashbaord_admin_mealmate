# F032 — Spec After Fixes

## Purpose
تنفيذ **Busy Status Automation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/busy_status_automation` | List/search |
| GET | `/api/v1/busy_status_automation/{id}` | Details |
| POST | `/api/v1/busy_status_automation` | Create/request |
| PUT | `/api/v1/busy_status_automation/{id}` | Update |
| POST | `/api/v1/busy_status_automation/{id}/actions/{action}` | State transition |
