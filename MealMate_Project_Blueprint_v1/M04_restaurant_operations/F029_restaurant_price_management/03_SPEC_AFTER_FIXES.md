# F029 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Price Management** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_price_management` | List/search |
| GET | `/api/v1/restaurant_price_management/{id}` | Details |
| POST | `/api/v1/restaurant_price_management` | Create/request |
| PUT | `/api/v1/restaurant_price_management/{id}` | Update |
| POST | `/api/v1/restaurant_price_management/{id}/actions/{action}` | State transition |
