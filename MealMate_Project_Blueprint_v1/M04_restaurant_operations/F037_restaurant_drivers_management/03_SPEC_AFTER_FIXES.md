# F037 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Drivers Management** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_drivers_management` | List/search |
| GET | `/api/v1/restaurant_drivers_management/{id}` | Details |
| POST | `/api/v1/restaurant_drivers_management` | Create/request |
| PUT | `/api/v1/restaurant_drivers_management/{id}` | Update |
| POST | `/api/v1/restaurant_drivers_management/{id}/actions/{action}` | State transition |
