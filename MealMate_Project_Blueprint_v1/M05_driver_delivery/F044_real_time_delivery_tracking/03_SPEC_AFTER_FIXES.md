# F044 — Spec After Fixes

## Purpose
تنفيذ **Real-Time Delivery Tracking** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/real_time_delivery_tracking` | List/search |
| GET | `/api/v1/real_time_delivery_tracking/{id}` | Details |
| POST | `/api/v1/real_time_delivery_tracking` | Create/request |
| PUT | `/api/v1/real_time_delivery_tracking/{id}` | Update |
| POST | `/api/v1/real_time_delivery_tracking/{id}/actions/{action}` | State transition |
