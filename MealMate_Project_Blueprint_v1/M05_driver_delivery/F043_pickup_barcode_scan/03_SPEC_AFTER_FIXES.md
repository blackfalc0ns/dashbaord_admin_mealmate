# F043 — Spec After Fixes

## Purpose
تنفيذ **Pickup Barcode Scan** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/pickup_barcode_scan` | List/search |
| GET | `/api/v1/pickup_barcode_scan/{id}` | Details |
| POST | `/api/v1/pickup_barcode_scan` | Create/request |
| PUT | `/api/v1/pickup_barcode_scan/{id}` | Update |
| POST | `/api/v1/pickup_barcode_scan/{id}/actions/{action}` | State transition |
