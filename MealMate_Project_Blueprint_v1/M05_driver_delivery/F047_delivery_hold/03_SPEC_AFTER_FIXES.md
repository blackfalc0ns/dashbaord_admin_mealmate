# F047 — Spec After Fixes

## Purpose
تنفيذ **Delivery Hold** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/delivery_hold` | List/search |
| GET | `/api/v1/delivery_hold/{id}` | Details |
| POST | `/api/v1/delivery_hold` | Create/request |
| PUT | `/api/v1/delivery_hold/{id}` | Update |
| POST | `/api/v1/delivery_hold/{id}/actions/{action}` | State transition |
