# F049 — Spec After Fixes

## Purpose
تنفيذ **Delivery Confirmation Scan** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/delivery_confirmation_scan` | List/search |
| GET | `/api/v1/delivery_confirmation_scan/{id}` | Details |
| POST | `/api/v1/delivery_confirmation_scan` | Create/request |
| PUT | `/api/v1/delivery_confirmation_scan/{id}` | Update |
| POST | `/api/v1/delivery_confirmation_scan/{id}/actions/{action}` | State transition |
