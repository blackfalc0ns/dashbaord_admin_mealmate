# F045 — Spec After Fixes

## Purpose
تنفيذ **Safe Contact** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/safe_contact` | List/search |
| GET | `/api/v1/safe_contact/{id}` | Details |
| POST | `/api/v1/safe_contact` | Create/request |
| PUT | `/api/v1/safe_contact/{id}` | Update |
| POST | `/api/v1/safe_contact/{id}/actions/{action}` | State transition |
