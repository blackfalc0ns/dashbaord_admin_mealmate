# F041 — Spec After Fixes

## Purpose
تنفيذ **Geographic Order Reception Range** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/geographic_order_reception_range` | List/search |
| GET | `/api/v1/geographic_order_reception_range/{id}` | Details |
| POST | `/api/v1/geographic_order_reception_range` | Create/request |
| PUT | `/api/v1/geographic_order_reception_range/{id}` | Update |
| POST | `/api/v1/geographic_order_reception_range/{id}/actions/{action}` | State transition |
