# F046 — Spec After Fixes

## Purpose
تنفيذ **Three-Kilometer Call Rule** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/three_kilometer_call_rule` | List/search |
| GET | `/api/v1/three_kilometer_call_rule/{id}` | Details |
| POST | `/api/v1/three_kilometer_call_rule` | Create/request |
| PUT | `/api/v1/three_kilometer_call_rule/{id}` | Update |
| POST | `/api/v1/three_kilometer_call_rule/{id}/actions/{action}` | State transition |
