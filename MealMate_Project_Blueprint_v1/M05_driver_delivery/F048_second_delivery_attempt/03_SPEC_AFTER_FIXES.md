# F048 — Spec After Fixes

## Purpose
تنفيذ **Second Delivery Attempt** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/second_delivery_attempt` | List/search |
| GET | `/api/v1/second_delivery_attempt/{id}` | Details |
| POST | `/api/v1/second_delivery_attempt` | Create/request |
| PUT | `/api/v1/second_delivery_attempt/{id}` | Update |
| POST | `/api/v1/second_delivery_attempt/{id}/actions/{action}` | State transition |
