# F040 — Spec After Fixes

## Purpose
تنفيذ **Driver Profile & Documents** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/driver_profile_documents` | List/search |
| GET | `/api/v1/driver_profile_documents/{id}` | Details |
| POST | `/api/v1/driver_profile_documents` | Create/request |
| PUT | `/api/v1/driver_profile_documents/{id}` | Update |
| POST | `/api/v1/driver_profile_documents/{id}/actions/{action}` | State transition |
