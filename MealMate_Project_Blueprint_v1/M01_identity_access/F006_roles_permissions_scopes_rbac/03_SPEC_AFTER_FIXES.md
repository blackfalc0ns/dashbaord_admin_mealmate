# F006 — Spec After Fixes

## Purpose
تنفيذ **Roles, Permissions & Scopes (RBAC)** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/roles_permissions_scopes_rbac` | List/search |
| GET | `/api/v1/roles_permissions_scopes_rbac/{id}` | Details |
| POST | `/api/v1/roles_permissions_scopes_rbac` | Create/request |
| PUT | `/api/v1/roles_permissions_scopes_rbac/{id}` | Update |
| POST | `/api/v1/roles_permissions_scopes_rbac/{id}/actions/{action}` | State transition |
