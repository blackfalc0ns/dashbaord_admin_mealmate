# F007 — Spec After Fixes

## Purpose
تنفيذ **Document Verification** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/document_verification` | List/search |
| GET | `/api/v1/document_verification/{id}` | Details |
| POST | `/api/v1/document_verification` | Create/request |
| PUT | `/api/v1/document_verification/{id}` | Update |
| POST | `/api/v1/document_verification/{id}/actions/{action}` | State transition |
