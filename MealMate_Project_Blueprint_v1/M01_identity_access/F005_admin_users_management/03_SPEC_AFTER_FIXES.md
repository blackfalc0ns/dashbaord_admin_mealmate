# F005 — Spec After Fixes

## Purpose
تنفيذ **Admin Users Management** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/admin_users_management` | List/search |
| GET | `/api/v1/admin_users_management/{id}` | Details |
| POST | `/api/v1/admin_users_management` | Create/request |
| PUT | `/api/v1/admin_users_management/{id}` | Update |
| POST | `/api/v1/admin_users_management/{id}/actions/{action}` | State transition |
