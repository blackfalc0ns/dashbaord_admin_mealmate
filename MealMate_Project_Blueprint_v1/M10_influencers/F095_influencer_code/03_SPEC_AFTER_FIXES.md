# F095 — Spec After Fixes

## Purpose
تنفيذ **Influencer Code** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/influencer_code` | List/search |
| GET | `/api/v1/influencer_code/{id}` | Details |
| POST | `/api/v1/influencer_code` | Create/request |
| PUT | `/api/v1/influencer_code/{id}` | Update |
| POST | `/api/v1/influencer_code/{id}/actions/{action}` | State transition |
