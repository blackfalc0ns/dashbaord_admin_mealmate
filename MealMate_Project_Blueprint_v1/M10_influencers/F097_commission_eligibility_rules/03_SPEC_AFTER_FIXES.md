# F097 — Spec After Fixes

## Purpose
تنفيذ **Commission Eligibility Rules** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/commission_eligibility_rules` | List/search |
| GET | `/api/v1/commission_eligibility_rules/{id}` | Details |
| POST | `/api/v1/commission_eligibility_rules` | Create/request |
| PUT | `/api/v1/commission_eligibility_rules/{id}` | Update |
| POST | `/api/v1/commission_eligibility_rules/{id}/actions/{action}` | State transition |
