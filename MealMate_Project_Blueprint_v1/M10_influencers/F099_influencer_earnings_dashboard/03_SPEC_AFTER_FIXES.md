# F099 — Spec After Fixes

## Purpose
تنفيذ **Influencer Earnings Dashboard** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/influencer_earnings_dashboard` | List/search |
| GET | `/api/v1/influencer_earnings_dashboard/{id}` | Details |
| POST | `/api/v1/influencer_earnings_dashboard` | Create/request |
| PUT | `/api/v1/influencer_earnings_dashboard/{id}` | Update |
| POST | `/api/v1/influencer_earnings_dashboard/{id}/actions/{action}` | State transition |
