# F096 — Spec After Fixes

## Purpose
تنفيذ **Influencer Commission Calculation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/influencer_commission_calculation` | List/search |
| GET | `/api/v1/influencer_commission_calculation/{id}` | Details |
| POST | `/api/v1/influencer_commission_calculation` | Create/request |
| PUT | `/api/v1/influencer_commission_calculation/{id}` | Update |
| POST | `/api/v1/influencer_commission_calculation/{id}/actions/{action}` | State transition |
