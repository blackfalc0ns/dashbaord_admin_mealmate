# F101 — Spec After Fixes

## Purpose
تنفيذ **Influencer Withdrawal Approval** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/influencer_withdrawal_approval` | List/search |
| GET | `/api/v1/influencer_withdrawal_approval/{id}` | Details |
| POST | `/api/v1/influencer_withdrawal_approval` | Create/request |
| PUT | `/api/v1/influencer_withdrawal_approval/{id}` | Update |
| POST | `/api/v1/influencer_withdrawal_approval/{id}/actions/{action}` | State transition |
