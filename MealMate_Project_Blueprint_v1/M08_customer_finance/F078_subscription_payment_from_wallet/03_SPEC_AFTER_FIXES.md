# F078 — Spec After Fixes

## Purpose
تنفيذ **Subscription Payment from Wallet** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/subscription_payment_from_wallet` | List/search |
| GET | `/api/v1/subscription_payment_from_wallet/{id}` | Details |
| POST | `/api/v1/subscription_payment_from_wallet` | Create/request |
| PUT | `/api/v1/subscription_payment_from_wallet/{id}` | Update |
| POST | `/api/v1/subscription_payment_from_wallet/{id}/actions/{action}` | State transition |
