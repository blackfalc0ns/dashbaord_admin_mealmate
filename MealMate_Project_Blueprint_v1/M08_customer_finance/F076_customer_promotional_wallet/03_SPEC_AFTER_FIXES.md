# F076 — Spec After Fixes

## Purpose
تنفيذ **Customer Promotional Wallet** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/customer_promotional_wallet` | List/search |
| GET | `/api/v1/customer_promotional_wallet/{id}` | Details |
| POST | `/api/v1/customer_promotional_wallet` | Create/request |
| PUT | `/api/v1/customer_promotional_wallet/{id}` | Update |
| POST | `/api/v1/customer_promotional_wallet/{id}/actions/{action}` | State transition |
