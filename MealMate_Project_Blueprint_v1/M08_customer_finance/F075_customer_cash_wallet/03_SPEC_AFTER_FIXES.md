# F075 — Spec After Fixes

## Purpose
تنفيذ **Customer Cash Wallet** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/customer_cash_wallet` | List/search |
| GET | `/api/v1/customer_cash_wallet/{id}` | Details |
| POST | `/api/v1/customer_cash_wallet` | Create/request |
| PUT | `/api/v1/customer_cash_wallet/{id}` | Update |
| POST | `/api/v1/customer_cash_wallet/{id}/actions/{action}` | State transition |
