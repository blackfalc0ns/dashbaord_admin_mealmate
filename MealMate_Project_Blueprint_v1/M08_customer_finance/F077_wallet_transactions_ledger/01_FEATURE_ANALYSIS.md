...
2. **تفصيل API Contract**
   - إضافة schemas لكل endpoint:
     - `GET /api/v1/wallet_transactions_ledger`
     - `GET /api/v1/wallet_transactions_ledger/{id}`
     - `POST /api/v1/wallet_transactions_ledger`
     - `PUT /api/v1/wallet_transactions_ledger/{id}`
     - `POST /api/v1/wallet_transactions_ledger/{id}/actions/{action}`
...
3. **تفصيل صلاحيات Role/Scope**
   - ربط كل شاشة وكل endpoint بصلاحية مثل `F077.View`, `F077.Create`, `F077.Update`, `F077.Override`.
