# F077 — Spec After Fixes

## Purpose
تنفيذ **Wallet Transactions Ledger** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/wallet_transactions_ledger` | List/search |
| GET | `/api/v1/wallet_transactions_ledger/{id}` | Details |
| POST | `/api/v1/wallet_transactions_ledger` | Create/request |
| PUT | `/api/v1/wallet_transactions_ledger/{id}` | Update |
| POST | `/api/v1/wallet_transactions_ledger/{id}/actions/{action}` | State transition |
