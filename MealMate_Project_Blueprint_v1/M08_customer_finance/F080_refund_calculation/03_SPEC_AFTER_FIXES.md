# F080 — Spec After Fixes

## Purpose
تنفيذ **Refund Calculation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/refund_calculation` | List/search |
| GET | `/api/v1/refund_calculation/{id}` | Details |
| POST | `/api/v1/refund_calculation` | Create/request |
| PUT | `/api/v1/refund_calculation/{id}` | Update |
| POST | `/api/v1/refund_calculation/{id}/actions/{action}` | State transition |
