# F083 — Spec After Fixes

## Purpose
تنفيذ **Customer Bank Details** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/customer_bank_details` | List/search |
| GET | `/api/v1/customer_bank_details/{id}` | Details |
| POST | `/api/v1/customer_bank_details` | Create/request |
| PUT | `/api/v1/customer_bank_details/{id}` | Update |
| POST | `/api/v1/customer_bank_details/{id}/actions/{action}` | State transition |
