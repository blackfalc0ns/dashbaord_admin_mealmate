# F081 — Spec After Fixes

## Purpose
تنفيذ **Cancellation Fees** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/cancellation_fees` | List/search |
| GET | `/api/v1/cancellation_fees/{id}` | Details |
| POST | `/api/v1/cancellation_fees` | Create/request |
| PUT | `/api/v1/cancellation_fees/{id}` | Update |
| POST | `/api/v1/cancellation_fees/{id}/actions/{action}` | State transition |
