# F084 — Spec After Fixes

## Purpose
تنفيذ **Payments & Refund History** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/payments_refund_history` | List/search |
| GET | `/api/v1/payments_refund_history/{id}` | Details |
| POST | `/api/v1/payments_refund_history` | Create/request |
| PUT | `/api/v1/payments_refund_history/{id}` | Update |
| POST | `/api/v1/payments_refund_history/{id}/actions/{action}` | State transition |
