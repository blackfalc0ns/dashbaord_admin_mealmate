# F079 — Spec After Fixes

## Purpose
تنفيذ **Subscription Cancellation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/subscription_cancellation` | List/search |
| GET | `/api/v1/subscription_cancellation/{id}` | Details |
| POST | `/api/v1/subscription_cancellation` | Create/request |
| PUT | `/api/v1/subscription_cancellation/{id}` | Update |
| POST | `/api/v1/subscription_cancellation/{id}/actions/{action}` | State transition |
