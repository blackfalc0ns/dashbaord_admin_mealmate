# F082 — Spec After Fixes

## Purpose
تنفيذ **Customer Withdrawal Request** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/customer_withdrawal_request` | List/search |
| GET | `/api/v1/customer_withdrawal_request/{id}` | Details |
| POST | `/api/v1/customer_withdrawal_request` | Create/request |
| PUT | `/api/v1/customer_withdrawal_request/{id}` | Update |
| POST | `/api/v1/customer_withdrawal_request/{id}/actions/{action}` | State transition |
