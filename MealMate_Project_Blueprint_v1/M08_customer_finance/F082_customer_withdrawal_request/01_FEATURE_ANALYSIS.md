...
2. **تفصيل API Contract**
   - إضافة schemas لكل endpoint:
     - `GET /api/v1/customer_withdrawal_request`
     - `GET /api/v1/customer_withdrawal_request/{id}`
     - `POST /api/v1/customer_withdrawal_request`
     - `PUT /api/v1/customer_withdrawal_request/{id}`
     - `POST /api/v1/customer_withdrawal_request/{id}/actions/{action}`
...
3. **تفصيل صلاحيات Role/Scope**
   - ربط كل شاشة وكل endpoint بصلاحية مثل `F082.View`, `F082.Create`, `F082.Update`, `F082.Override`.
