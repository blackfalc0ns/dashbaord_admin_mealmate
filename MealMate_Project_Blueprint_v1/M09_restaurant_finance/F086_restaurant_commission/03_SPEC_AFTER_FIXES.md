# F086 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Commission** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_commission` | List/search |
| GET | `/api/v1/restaurant_commission/{id}` | Details |
| POST | `/api/v1/restaurant_commission` | Create/request |
| PUT | `/api/v1/restaurant_commission/{id}` | Update |
| POST | `/api/v1/restaurant_commission/{id}/actions/{action}` | State transition |
