# F085 — Spec After Fixes

## Purpose
تنفيذ **Meal Payable Calculation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/meal_payable_calculation` | List/search |
| GET | `/api/v1/meal_payable_calculation/{id}` | Details |
| POST | `/api/v1/meal_payable_calculation` | Create/request |
| PUT | `/api/v1/meal_payable_calculation/{id}` | Update |
| POST | `/api/v1/meal_payable_calculation/{id}/actions/{action}` | State transition |
