# F087 — Spec After Fixes

## Purpose
تنفيذ **Complaint Deductions** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/complaint_deductions` | List/search |
| GET | `/api/v1/complaint_deductions/{id}` | Details |
| POST | `/api/v1/complaint_deductions` | Create/request |
| PUT | `/api/v1/complaint_deductions/{id}` | Update |
| POST | `/api/v1/complaint_deductions/{id}/actions/{action}` | State transition |
