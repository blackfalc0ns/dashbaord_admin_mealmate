# F088 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Monthly Invoice** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_monthly_invoice` | List/search |
| GET | `/api/v1/restaurant_monthly_invoice/{id}` | Details |
| POST | `/api/v1/restaurant_monthly_invoice` | Create/request |
| PUT | `/api/v1/restaurant_monthly_invoice/{id}` | Update |
| POST | `/api/v1/restaurant_monthly_invoice/{id}/actions/{action}` | State transition |
