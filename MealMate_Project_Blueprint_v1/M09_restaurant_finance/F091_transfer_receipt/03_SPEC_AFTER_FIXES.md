# F091 — Spec After Fixes

## Purpose
تنفيذ **Transfer Receipt** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/transfer_receipt` | List/search |
| GET | `/api/v1/transfer_receipt/{id}` | Details |
| POST | `/api/v1/transfer_receipt` | Create/request |
| PUT | `/api/v1/transfer_receipt/{id}` | Update |
| POST | `/api/v1/transfer_receipt/{id}/actions/{action}` | State transition |
