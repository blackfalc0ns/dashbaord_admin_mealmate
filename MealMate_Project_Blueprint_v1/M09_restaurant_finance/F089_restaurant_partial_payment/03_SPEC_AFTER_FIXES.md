# F089 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Partial Payment** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_partial_payment` | List/search |
| GET | `/api/v1/restaurant_partial_payment/{id}` | Details |
| POST | `/api/v1/restaurant_partial_payment` | Create/request |
| PUT | `/api/v1/restaurant_partial_payment/{id}` | Update |
| POST | `/api/v1/restaurant_partial_payment/{id}/actions/{action}` | State transition |
