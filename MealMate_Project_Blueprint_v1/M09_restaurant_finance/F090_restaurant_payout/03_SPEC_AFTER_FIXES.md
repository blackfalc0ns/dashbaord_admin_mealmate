# F090 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Payout** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_payout` | List/search |
| GET | `/api/v1/restaurant_payout/{id}` | Details |
| POST | `/api/v1/restaurant_payout` | Create/request |
| PUT | `/api/v1/restaurant_payout/{id}` | Update |
| POST | `/api/v1/restaurant_payout/{id}/actions/{action}` | State transition |
