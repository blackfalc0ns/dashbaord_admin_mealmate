# F092 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Account Statement** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_account_statement` | List/search |
| GET | `/api/v1/restaurant_account_statement/{id}` | Details |
| POST | `/api/v1/restaurant_account_statement` | Create/request |
| PUT | `/api/v1/restaurant_account_statement/{id}` | Update |
| POST | `/api/v1/restaurant_account_statement/{id}/actions/{action}` | State transition |
