# F093 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Financial Reports** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_financial_reports` | List/search |
| GET | `/api/v1/restaurant_financial_reports/{id}` | Details |
| POST | `/api/v1/restaurant_financial_reports` | Create/request |
| PUT | `/api/v1/restaurant_financial_reports/{id}` | Update |
| POST | `/api/v1/restaurant_financial_reports/{id}/actions/{action}` | State transition |
