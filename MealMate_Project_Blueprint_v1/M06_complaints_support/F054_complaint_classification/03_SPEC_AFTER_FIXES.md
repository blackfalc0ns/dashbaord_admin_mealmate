# F054 — Spec After Fixes

## Purpose
تنفيذ **Complaint Classification** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/complaint_classification` | List/search |
| GET | `/api/v1/complaint_classification/{id}` | Details |
| POST | `/api/v1/complaint_classification` | Create/request |
| PUT | `/api/v1/complaint_classification/{id}` | Update |
| POST | `/api/v1/complaint_classification/{id}/actions/{action}` | State transition |
