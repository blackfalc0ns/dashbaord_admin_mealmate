# F052 — Spec After Fixes

## Purpose
تنفيذ **Complaint Creation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/complaint_creation` | List/search |
| GET | `/api/v1/complaint_creation/{id}` | Details |
| POST | `/api/v1/complaint_creation` | Create/request |
| PUT | `/api/v1/complaint_creation/{id}` | Update |
| POST | `/api/v1/complaint_creation/{id}/actions/{action}` | State transition |
