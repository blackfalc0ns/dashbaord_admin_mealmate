# F053 — Spec After Fixes

## Purpose
تنفيذ **Complaint Evidence Photos** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/complaint_evidence_photos` | List/search |
| GET | `/api/v1/complaint_evidence_photos/{id}` | Details |
| POST | `/api/v1/complaint_evidence_photos` | Create/request |
| PUT | `/api/v1/complaint_evidence_photos/{id}` | Update |
| POST | `/api/v1/complaint_evidence_photos/{id}/actions/{action}` | State transition |
