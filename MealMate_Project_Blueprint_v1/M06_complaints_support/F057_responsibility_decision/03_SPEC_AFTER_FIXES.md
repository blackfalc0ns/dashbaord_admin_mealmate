# F057 — Spec After Fixes

## Purpose
تنفيذ **Responsibility Decision** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/responsibility_decision` | List/search |
| GET | `/api/v1/responsibility_decision/{id}` | Details |
| POST | `/api/v1/responsibility_decision` | Create/request |
| PUT | `/api/v1/responsibility_decision/{id}` | Update |
| POST | `/api/v1/responsibility_decision/{id}/actions/{action}` | State transition |
