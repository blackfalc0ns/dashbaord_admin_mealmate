# F059 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Box Deduction** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_box_deduction` | List/search |
| GET | `/api/v1/restaurant_box_deduction/{id}` | Details |
| POST | `/api/v1/restaurant_box_deduction` | Create/request |
| PUT | `/api/v1/restaurant_box_deduction/{id}` | Update |
| POST | `/api/v1/restaurant_box_deduction/{id}/actions/{action}` | State transition |
