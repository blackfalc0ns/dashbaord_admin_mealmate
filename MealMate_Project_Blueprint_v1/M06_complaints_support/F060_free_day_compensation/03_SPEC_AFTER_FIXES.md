# F060 — Spec After Fixes

## Purpose
تنفيذ **Free Day Compensation** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/free_day_compensation` | List/search |
| GET | `/api/v1/free_day_compensation/{id}` | Details |
| POST | `/api/v1/free_day_compensation` | Create/request |
| PUT | `/api/v1/free_day_compensation/{id}` | Update |
| POST | `/api/v1/free_day_compensation/{id}/actions/{action}` | State transition |
