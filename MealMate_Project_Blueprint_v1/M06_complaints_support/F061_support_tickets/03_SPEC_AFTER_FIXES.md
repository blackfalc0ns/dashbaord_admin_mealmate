# F061 — Spec After Fixes

## Purpose
تنفيذ **Support Tickets** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/support_tickets` | List/search |
| GET | `/api/v1/support_tickets/{id}` | Details |
| POST | `/api/v1/support_tickets` | Create/request |
| PUT | `/api/v1/support_tickets/{id}` | Update |
| POST | `/api/v1/support_tickets/{id}/actions/{action}` | State transition |
