# F015 — Spec After Fixes

## Purpose
تنفيذ **Family Subscription** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/family_subscription` | List/search |
| GET | `/api/v1/family_subscription/{id}` | Details |
| POST | `/api/v1/family_subscription` | Create/request |
| PUT | `/api/v1/family_subscription/{id}` | Update |
| POST | `/api/v1/family_subscription/{id}/actions/{action}` | State transition |
