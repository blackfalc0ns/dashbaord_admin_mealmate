# F016 — Spec After Fixes

## Purpose
تنفيذ **Promo, Referral & Discount Codes** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/promo_referral_discount_codes` | List/search |
| GET | `/api/v1/promo_referral_discount_codes/{id}` | Details |
| POST | `/api/v1/promo_referral_discount_codes` | Create/request |
| PUT | `/api/v1/promo_referral_discount_codes/{id}` | Update |
| POST | `/api/v1/promo_referral_discount_codes/{id}/actions/{action}` | State transition |
