# F017 — Spec After Fixes

## Purpose
تنفيذ **Subscription Tier Upgrade** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/subscription_tier_upgrade` | List/search |
| GET | `/api/v1/subscription_tier_upgrade/{id}` | Details |
| POST | `/api/v1/subscription_tier_upgrade` | Create/request |
| PUT | `/api/v1/subscription_tier_upgrade/{id}` | Update |
| POST | `/api/v1/subscription_tier_upgrade/{id}/actions/{action}` | State transition |
