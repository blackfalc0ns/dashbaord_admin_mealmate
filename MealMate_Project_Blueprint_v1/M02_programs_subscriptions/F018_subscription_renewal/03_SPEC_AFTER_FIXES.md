# F018 — Spec After Fixes

## Purpose
تنفيذ **Subscription Renewal** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/subscription_renewal` | List/search |
| GET | `/api/v1/subscription_renewal/{id}` | Details |
| POST | `/api/v1/subscription_renewal` | Create/request |
| PUT | `/api/v1/subscription_renewal/{id}` | Update |
| POST | `/api/v1/subscription_renewal/{id}/actions/{action}` | State transition |
