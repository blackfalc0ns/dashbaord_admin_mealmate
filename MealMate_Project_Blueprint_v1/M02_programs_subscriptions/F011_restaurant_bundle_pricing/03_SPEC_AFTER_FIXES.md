# F011 — Spec After Fixes

## Purpose
تنفيذ **Restaurant Bundle Pricing** كميزة جاهزة للتطوير بعد معالجة نقاط الضعف والفجوات.
...
|---|---|---|
| GET | `/api/v1/restaurant_bundle_pricing` | List/search |
| GET | `/api/v1/restaurant_bundle_pricing/{id}` | Details |
| POST | `/api/v1/restaurant_bundle_pricing` | Create/request |
| PUT | `/api/v1/restaurant_bundle_pricing/{id}` | Update |
| POST | `/api/v1/restaurant_bundle_pricing/{id}/actions/{action}` | State transition |
