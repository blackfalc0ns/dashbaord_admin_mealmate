...
@Component({
  ...
  standalone: true,
  imports: [NgClass, RouterLink, ZardButtonComponent, ZardCardComponent],
...
export class SecurityAdminPageComponent {
  ...
  private resolvePage(): SecurityAdminPage {
    const pageId = this.route.snapshot.data['securityPage'] as
      | SecurityAdminPageId
      | undefined;

    return SECURITY_ADMIN_PAGES[pageId ?? 'roles'];
  }
