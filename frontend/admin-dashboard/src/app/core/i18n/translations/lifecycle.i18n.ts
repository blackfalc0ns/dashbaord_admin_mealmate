...
export const LIFECYCLE_I18N: Record<LifecycleLocale, LifecycleCopy> = {
  ar: {
    ...
    policyStartDelayDesc: '3 أيام محجوزة للطلبات القادمة (نافذة 72 ساعة) قبل بدء التجميد',
  ...
  en: {
    ...
    policyStartDelayDesc: 'Three days reserved for upcoming orders (72-hour window) before freeze starts',
