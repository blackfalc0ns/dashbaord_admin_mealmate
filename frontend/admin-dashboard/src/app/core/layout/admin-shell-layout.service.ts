...
@Injectable()
export class AdminShellLayoutService {
  private readonly destroyRef = inject(DestroyRef);

  readonly viewport = signal<AdminViewport>('desktop');
  readonly mobileNavOpen = signal(false);
  /** User preference on desktop / wide — ignored on tablet (always rail). */
  ...
  readonly isOverlay = computed(() => this.isMobile());
  ...
  private resolveViewport(): AdminViewport {
