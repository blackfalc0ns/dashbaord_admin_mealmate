...
## الشرح المختصر
ميزة **تسجيل واعتماد المطعم** جزء من **إدارة الحسابات والوصول**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_registration_approval`
- `GET /api/v1/restaurant_registration_approval/{id}`
- `POST /api/v1/restaurant_registration_approval`
- `PUT /api/v1/restaurant_registration_approval/{id}`
- `POST /api/v1/restaurant_registration_approval/{id}/actions/{action}`
### معايير API
