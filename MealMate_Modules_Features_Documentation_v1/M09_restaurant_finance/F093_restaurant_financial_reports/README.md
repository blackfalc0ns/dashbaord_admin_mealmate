...
## الشرح المختصر
ميزة **تقارير المطعم المالية** جزء من **النظام المالي للمطعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_financial_reports`
- `GET /api/v1/restaurant_financial_reports/{id}`
- `POST /api/v1/restaurant_financial_reports`
- `PUT /api/v1/restaurant_financial_reports/{id}`
- `POST /api/v1/restaurant_financial_reports/{id}/actions/{action}`
### معايير API
