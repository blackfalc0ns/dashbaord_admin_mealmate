# F085 — حساب مستحق الوجبة

## Meal Payable Calculation
...
## الشرح المختصر
ميزة **حساب مستحق الوجبة** جزء من **النظام المالي للمطعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/meal_payable_calculation`
- `GET /api/v1/meal_payable_calculation/{id}`
- `POST /api/v1/meal_payable_calculation`
- `PUT /api/v1/meal_payable_calculation/{id}`
- `POST /api/v1/meal_payable_calculation/{id}/actions/{action}`
### معايير API
