# F092 — كشف حساب المطعم

## Restaurant Account Statement
...
## الشرح المختصر
ميزة **كشف حساب المطعم** جزء من **النظام المالي للمطعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_account_statement`
- `GET /api/v1/restaurant_account_statement/{id}`
- `POST /api/v1/restaurant_account_statement`
- `PUT /api/v1/restaurant_account_statement/{id}`
- `POST /api/v1/restaurant_account_statement/{id}/actions/{action}`
### معايير API
