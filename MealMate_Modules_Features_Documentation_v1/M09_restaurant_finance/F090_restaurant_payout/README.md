...
## الشرح المختصر
ميزة **سداد مستحقات المطعم** جزء من **النظام المالي للمطعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_payout`
- `GET /api/v1/restaurant_payout/{id}`
- `POST /api/v1/restaurant_payout`
- `PUT /api/v1/restaurant_payout/{id}`
- `POST /api/v1/restaurant_payout/{id}/actions/{action}`
### معايير API
