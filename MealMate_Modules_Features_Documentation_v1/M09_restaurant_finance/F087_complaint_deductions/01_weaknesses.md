# F087 — نقاط الضعف التفصيلية

## الميزة
**Complaint Deductions**  
الميزة جزء من **M09 — النظام المالي للمطعم**، ومجالها الأساسي: حساب مستحق الوجبة، عمولة المطعم، خصومات الشكاوى، الفاتورة الشهرية، الدفعات، التحويل، كشف الحساب، وتقارير المطعم المالية.
