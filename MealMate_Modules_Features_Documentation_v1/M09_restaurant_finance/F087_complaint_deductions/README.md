...
## الشرح المختصر
ميزة **خصومات الشكاوى** جزء من **النظام المالي للمطعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/complaint_deductions`
- `GET /api/v1/complaint_deductions/{id}`
- `POST /api/v1/complaint_deductions`
- `PUT /api/v1/complaint_deductions/{id}`
- `POST /api/v1/complaint_deductions/{id}/actions/{action}`
### معايير API
