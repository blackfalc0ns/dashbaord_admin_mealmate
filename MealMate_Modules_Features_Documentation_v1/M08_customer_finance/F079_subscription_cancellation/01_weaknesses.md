# F079 — نقاط الضعف التفصيلية

## الميزة
**Subscription Cancellation**  
الميزة جزء من **M08 — النظام المالي للعميل**، ومجالها الأساسي: محفظة العميل النقدية والترويجية، سجل الحركات، الدفع من المحفظة، الإلغاء، الاسترداد، رسوم الإلغاء، السحب، والبيانات البنكية.
