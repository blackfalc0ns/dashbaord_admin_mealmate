...
## الشرح المختصر
ميزة **إلغاء الاشتراك** جزء من **النظام المالي للعميل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/subscription_cancellation`
- `GET /api/v1/subscription_cancellation/{id}`
- `POST /api/v1/subscription_cancellation`
- `PUT /api/v1/subscription_cancellation/{id}`
- `POST /api/v1/subscription_cancellation/{id}/actions/{action}`
### معايير API
