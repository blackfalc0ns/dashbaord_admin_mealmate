# F076 — المحفظة الترويجية

## Customer Promotional Wallet
...
## الشرح المختصر
ميزة **المحفظة الترويجية** جزء من **النظام المالي للعميل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- **قاعدة خاصة:** تعويضات ومكافآت فقط.
- **قاعدة خاصة:** غير قابل للسحب.
- **قاعدة خاصة:** قد يحمل تاريخ انتهاء.
...
### APIs
- `GET /api/v1/customer_promotional_wallet`
- `GET /api/v1/customer_promotional_wallet/{id}`
- `POST /api/v1/customer_promotional_wallet`
- `PUT /api/v1/customer_promotional_wallet/{id}`
- `POST /api/v1/customer_promotional_wallet/{id}/actions/{action}`
### معايير API
