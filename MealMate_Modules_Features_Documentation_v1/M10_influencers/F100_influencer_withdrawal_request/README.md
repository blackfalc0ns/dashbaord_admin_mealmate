# F100 — طلب تحصيل المؤثر

## Influencer Withdrawal Request
...
## الشرح المختصر
ميزة **طلب تحصيل المؤثر** جزء من **نظام المؤثرين**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/influencer_withdrawal_request`
- `GET /api/v1/influencer_withdrawal_request/{id}`
- `POST /api/v1/influencer_withdrawal_request`
- `PUT /api/v1/influencer_withdrawal_request/{id}`
- `POST /api/v1/influencer_withdrawal_request/{id}/actions/{action}`
### معايير API
