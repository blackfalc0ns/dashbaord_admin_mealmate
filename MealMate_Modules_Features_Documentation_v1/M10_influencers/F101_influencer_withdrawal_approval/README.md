# F101 — اعتماد تحصيل المؤثر

## Influencer Withdrawal Approval
...
## الشرح المختصر
ميزة **اعتماد تحصيل المؤثر** جزء من **نظام المؤثرين**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/influencer_withdrawal_approval`
- `GET /api/v1/influencer_withdrawal_approval/{id}`
- `POST /api/v1/influencer_withdrawal_approval`
- `PUT /api/v1/influencer_withdrawal_approval/{id}`
- `POST /api/v1/influencer_withdrawal_approval/{id}/actions/{action}`
### معايير API
