...
## الشرح المختصر
ميزة **شروط استحقاق العمولة** جزء من **نظام المؤثرين**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/commission_eligibility_rules`
- `GET /api/v1/commission_eligibility_rules/{id}`
- `POST /api/v1/commission_eligibility_rules`
- `PUT /api/v1/commission_eligibility_rules/{id}`
- `POST /api/v1/commission_eligibility_rules/{id}/actions/{action}`
### معايير API
