...
## الشرح المختصر
ميزة **لوحة أرباح المؤثر** جزء من **نظام المؤثرين**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/influencer_earnings_dashboard`
- `GET /api/v1/influencer_earnings_dashboard/{id}`
- `POST /api/v1/influencer_earnings_dashboard`
- `PUT /api/v1/influencer_earnings_dashboard/{id}`
- `POST /api/v1/influencer_earnings_dashboard/{id}/actions/{action}`
### معايير API
