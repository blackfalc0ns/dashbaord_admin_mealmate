# F094 — نقاط الضعف التفصيلية

## الميزة
**Link Influencer to Customer Account**  
الميزة جزء من **M10 — نظام المؤثرين**، ومجالها الأساسي: ربط المؤثر، الكود، احتساب العمولة، شروط الاستحقاق، أثر الإلغاء، لوحة الأرباح، طلبات السحب، وسجل المدفوعات.
