# F094 — ربط المؤثر بحساب العميل

## Link Influencer to Customer Account
...
## الشرح المختصر
ميزة **ربط المؤثر بحساب العميل** جزء من **نظام المؤثرين**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/link_influencer_to_customer_account`
- `GET /api/v1/link_influencer_to_customer_account/{id}`
- `POST /api/v1/link_influencer_to_customer_account`
- `PUT /api/v1/link_influencer_to_customer_account/{id}`
- `POST /api/v1/link_influencer_to_customer_account/{id}/actions/{action}`
### معايير API
