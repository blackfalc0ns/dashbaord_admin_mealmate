...
## الشرح المختصر
ميزة **الحساسية والتفضيلات** جزء من **التقويم والوجبات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/allergies_dislikes_preferences`
- `GET /api/v1/allergies_dislikes_preferences/{id}`
- `POST /api/v1/allergies_dislikes_preferences`
- `PUT /api/v1/allergies_dislikes_preferences/{id}`
- `POST /api/v1/allergies_dislikes_preferences/{id}/actions/{action}`
### معايير API
