...
## الشرح المختصر
ميزة **الاختيار التلقائي** جزء من **التقويم والوجبات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- **قاعدة خاصة:** تصفية الحساسية والتفضيلات.
- **قاعدة خاصة:** تصفية المنطقة والبرنامج والباقة والطاقة.
- **قاعدة خاصة:** تطبيق التوزيع العادل والـLimit.
...
### APIs
- `GET /api/v1/automatic_selection`
- `GET /api/v1/automatic_selection/{id}`
- `POST /api/v1/automatic_selection`
- `PUT /api/v1/automatic_selection/{id}`
- `POST /api/v1/automatic_selection/{id}/actions/{action}`
### معايير API
