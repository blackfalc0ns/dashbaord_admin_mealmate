# F020 — اختيار المطعم اليومي

## Daily Restaurant Selection
...
## الشرح المختصر
ميزة **اختيار المطعم اليومي** جزء من **التقويم والوجبات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/daily_restaurant_selection`
- `GET /api/v1/daily_restaurant_selection/{id}`
- `POST /api/v1/daily_restaurant_selection`
- `PUT /api/v1/daily_restaurant_selection/{id}`
- `POST /api/v1/daily_restaurant_selection/{id}/actions/{action}`
### معايير API
