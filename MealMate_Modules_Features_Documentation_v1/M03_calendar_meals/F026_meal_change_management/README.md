...
## الشرح المختصر
ميزة **تغيير الوجبات** جزء من **التقويم والوجبات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/meal_change_management`
- `GET /api/v1/meal_change_management/{id}`
- `POST /api/v1/meal_change_management`
- `PUT /api/v1/meal_change_management/{id}`
- `POST /api/v1/meal_change_management/{id}/actions/{action}`
### معايير API
