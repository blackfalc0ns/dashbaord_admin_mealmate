# F024 — قاعدة التنويع والحد الأقصى

## Restaurant Diversification Limit
...
## الشرح المختصر
ميزة **قاعدة التنويع والحد الأقصى** جزء من **التقويم والوجبات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_diversification_limit`
- `GET /api/v1/restaurant_diversification_limit/{id}`
- `POST /api/v1/restaurant_diversification_limit`
- `PUT /api/v1/restaurant_diversification_limit/{id}`
- `POST /api/v1/restaurant_diversification_limit/{id}/actions/{action}`
### معايير API
