...
## الشرح المختصر
ميزة **برامج الحملة** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/campaign_programs`
- `GET /api/v1/campaign_programs/{id}`
- `POST /api/v1/campaign_programs`
- `PUT /api/v1/campaign_programs/{id}`
- `POST /api/v1/campaign_programs/{id}/actions/{action}`
### معايير API
