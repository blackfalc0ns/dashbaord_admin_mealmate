...
## الشرح المختصر
ميزة **الحسابات المالية للحملة** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/campaign_accounting`
- `GET /api/v1/campaign_accounting/{id}`
- `POST /api/v1/campaign_accounting`
- `PUT /api/v1/campaign_accounting/{id}`
- `POST /api/v1/campaign_accounting/{id}/actions/{action}`
### معايير API
