...
## الشرح المختصر
ميزة **إطلاق الحملة** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/campaign_launch`
- `GET /api/v1/campaign_launch/{id}`
- `POST /api/v1/campaign_launch`
- `PUT /api/v1/campaign_launch/{id}`
- `POST /api/v1/campaign_launch/{id}/actions/{action}`
### معايير API
