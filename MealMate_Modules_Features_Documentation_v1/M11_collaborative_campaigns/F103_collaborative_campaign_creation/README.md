...
## الشرح المختصر
ميزة **إنشاء الحملة التشاركية** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/collaborative_campaign_creation`
- `GET /api/v1/collaborative_campaign_creation/{id}`
- `POST /api/v1/collaborative_campaign_creation`
- `PUT /api/v1/collaborative_campaign_creation/{id}`
- `POST /api/v1/collaborative_campaign_creation/{id}/actions/{action}`
### معايير API
