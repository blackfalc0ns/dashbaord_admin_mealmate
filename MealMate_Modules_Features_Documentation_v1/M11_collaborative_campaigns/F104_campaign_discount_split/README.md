...
## الشرح المختصر
ميزة **توزيع خصم الحملة** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- **قاعدة خاصة:** total_discount=restaurant_share+platform_share.
- **قاعدة خاصة:** خيار عمولة full/half/none.
- **قاعدة خاصة:** حفظ Financial Snapshot.
...
### APIs
- `GET /api/v1/campaign_discount_split`
- `GET /api/v1/campaign_discount_split/{id}`
- `POST /api/v1/campaign_discount_split`
- `PUT /api/v1/campaign_discount_split/{id}`
- `POST /api/v1/campaign_discount_split/{id}/actions/{action}`
### معايير API
