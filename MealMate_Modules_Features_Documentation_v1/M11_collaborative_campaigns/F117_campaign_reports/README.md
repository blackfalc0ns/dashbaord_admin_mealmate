...
## الشرح المختصر
ميزة **تقارير الحملة** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/campaign_reports`
- `GET /api/v1/campaign_reports/{id}`
- `POST /api/v1/campaign_reports`
- `PUT /api/v1/campaign_reports/{id}`
- `POST /api/v1/campaign_reports/{id}/actions/{action}`
### معايير API
