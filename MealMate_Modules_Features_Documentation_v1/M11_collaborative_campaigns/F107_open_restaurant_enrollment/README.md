# F107 — فتح انضمام المطاعم

## Open Restaurant Enrollment
...
## الشرح المختصر
ميزة **فتح انضمام المطاعم** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/open_restaurant_enrollment`
- `GET /api/v1/open_restaurant_enrollment/{id}`
- `POST /api/v1/open_restaurant_enrollment`
- `PUT /api/v1/open_restaurant_enrollment/{id}`
- `POST /api/v1/open_restaurant_enrollment/{id}/actions/{action}`
### معايير API
