# F115 — زيادة سقف المشتركين

## Increase Campaign Subscriber Cap
...
## الشرح المختصر
ميزة **زيادة سقف المشتركين** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/increase_campaign_subscriber_cap`
- `GET /api/v1/increase_campaign_subscriber_cap/{id}`
- `POST /api/v1/increase_campaign_subscriber_cap`
- `PUT /api/v1/increase_campaign_subscriber_cap/{id}`
- `POST /api/v1/increase_campaign_subscriber_cap/{id}/actions/{action}`
### معايير API
