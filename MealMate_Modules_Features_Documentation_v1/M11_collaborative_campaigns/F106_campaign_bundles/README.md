...
## الشرح المختصر
ميزة **باقات الحملة** جزء من **الحملات التشاركية**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/campaign_bundles`
- `GET /api/v1/campaign_bundles/{id}`
- `POST /api/v1/campaign_bundles`
- `PUT /api/v1/campaign_bundles/{id}`
- `POST /api/v1/campaign_bundles/{id}/actions/{action}`
### معايير API
