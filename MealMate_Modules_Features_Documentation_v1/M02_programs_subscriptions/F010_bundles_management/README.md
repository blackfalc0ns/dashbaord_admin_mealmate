...
## الشرح المختصر
ميزة **إدارة الباقات** جزء من **البرامج والاشتراكات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/bundles_management`
- `GET /api/v1/bundles_management/{id}`
- `POST /api/v1/bundles_management`
- `PUT /api/v1/bundles_management/{id}`
- `POST /api/v1/bundles_management/{id}/actions/{action}`
### معايير API
