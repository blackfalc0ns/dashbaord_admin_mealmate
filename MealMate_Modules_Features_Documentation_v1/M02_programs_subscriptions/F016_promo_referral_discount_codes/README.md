...
## الشرح المختصر
ميزة **أكواد الخصم والإحالة** جزء من **البرامج والاشتراكات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/promo_referral_discount_codes`
- `GET /api/v1/promo_referral_discount_codes/{id}`
- `POST /api/v1/promo_referral_discount_codes`
- `PUT /api/v1/promo_referral_discount_codes/{id}`
- `POST /api/v1/promo_referral_discount_codes/{id}/actions/{action}`
### معايير API
