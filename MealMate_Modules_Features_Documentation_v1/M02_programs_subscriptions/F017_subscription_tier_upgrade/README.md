...
## الشرح المختصر
ميزة **ترقية تصنيف الاشتراك** جزء من **البرامج والاشتراكات**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/subscription_tier_upgrade`
- `GET /api/v1/subscription_tier_upgrade/{id}`
- `POST /api/v1/subscription_tier_upgrade`
- `PUT /api/v1/subscription_tier_upgrade/{id}`
- `POST /api/v1/subscription_tier_upgrade/{id}/actions/{action}`
### معايير API
