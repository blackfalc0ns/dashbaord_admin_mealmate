...
## الشرح المختصر
ميزة **لوحة مؤشرات الأداء** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/kpi_dashboard`
- `GET /api/v1/kpi_dashboard/{id}`
- `POST /api/v1/kpi_dashboard`
- `PUT /api/v1/kpi_dashboard/{id}`
- `POST /api/v1/kpi_dashboard/{id}/actions/{action}`
### معايير API
