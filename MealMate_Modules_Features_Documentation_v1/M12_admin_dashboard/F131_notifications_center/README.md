...
## الشرح المختصر
ميزة **مركز الإشعارات** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/notifications_center`
- `GET /api/v1/notifications_center/{id}`
- `POST /api/v1/notifications_center`
- `PUT /api/v1/notifications_center/{id}`
- `POST /api/v1/notifications_center/{id}/actions/{action}`
### معايير API
