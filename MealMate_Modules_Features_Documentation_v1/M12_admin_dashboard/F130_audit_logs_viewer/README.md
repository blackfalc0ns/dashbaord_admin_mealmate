...
## الشرح المختصر
ميزة **عرض سجلات التدقيق** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/audit_logs_viewer`
- `GET /api/v1/audit_logs_viewer/{id}`
- `POST /api/v1/audit_logs_viewer`
- `PUT /api/v1/audit_logs_viewer/{id}`
- `POST /api/v1/audit_logs_viewer/{id}/actions/{action}`
### معايير API
