...
## الشرح المختصر
ميزة **متابعة التشغيل** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/operations_monitoring`
- `GET /api/v1/operations_monitoring/{id}`
- `POST /api/v1/operations_monitoring`
- `PUT /api/v1/operations_monitoring/{id}`
- `POST /api/v1/operations_monitoring/{id}/actions/{action}`
### معايير API
