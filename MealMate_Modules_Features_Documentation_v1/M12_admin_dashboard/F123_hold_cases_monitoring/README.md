# F123 — متابعة حالات Hold

## Hold Cases Monitoring
...
## الشرح المختصر
ميزة **متابعة حالات Hold** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/hold_cases_monitoring`
- `GET /api/v1/hold_cases_monitoring/{id}`
- `POST /api/v1/hold_cases_monitoring`
- `PUT /api/v1/hold_cases_monitoring/{id}`
- `POST /api/v1/hold_cases_monitoring/{id}/actions/{action}`
### معايير API
