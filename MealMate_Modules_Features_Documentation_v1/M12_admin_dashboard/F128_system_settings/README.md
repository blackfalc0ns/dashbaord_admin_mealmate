...
## الشرح المختصر
ميزة **إعدادات النظام** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- `POST /api/v1/system_settings/{id}/actions/{action}`
### معايير API
