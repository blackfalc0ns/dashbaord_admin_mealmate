...
## الشرح المختصر
ميزة **الاعتمادات المعلقة** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/pending_approvals`
- `GET /api/v1/pending_approvals/{id}`
- `POST /api/v1/pending_approvals`
- `PUT /api/v1/pending_approvals/{id}`
- `POST /api/v1/pending_approvals/{id}/actions/{action}`
### معايير API
