...
## الشرح المختصر
ميزة **مركز الشكاوى** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/complaints_center`
- `GET /api/v1/complaints_center/{id}`
- `POST /api/v1/complaints_center`
- `PUT /api/v1/complaints_center/{id}`
- `POST /api/v1/complaints_center/{id}/actions/{action}`
### معايير API
