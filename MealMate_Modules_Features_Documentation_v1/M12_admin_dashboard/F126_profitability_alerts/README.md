...
- **قاعدة خاصة:** أسوأ سيناريو = أعلى تكلفة + أقل مدة.
- **قاعدة خاصة:** مقارنة الربح بحد الأمان.
- **قاعدة خاصة:** لا تغيير تلقائي بلا موافقة.
...
### APIs
- `GET /api/v1/profitability_alerts`
- `GET /api/v1/profitability_alerts/{id}`
- `POST /api/v1/profitability_alerts`
- `PUT /api/v1/profitability_alerts/{id}`
- `POST /api/v1/profitability_alerts/{id}/actions/{action}`
### معايير API
