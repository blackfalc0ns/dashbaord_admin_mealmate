...
## الشرح المختصر
ميزة **التقارير** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/admin_reports`
- `GET /api/v1/admin_reports/{id}`
- `POST /api/v1/admin_reports`
- `PUT /api/v1/admin_reports/{id}`
- `POST /api/v1/admin_reports/{id}/actions/{action}`
### معايير API
