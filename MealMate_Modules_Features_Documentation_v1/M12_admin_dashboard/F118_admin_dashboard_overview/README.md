...
## الشرح المختصر
ميزة **نظرة عامة للوحة الأدمن** جزء من **لوحة تحكم الأدمن**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/admin_dashboard_overview`
- `GET /api/v1/admin_dashboard_overview/{id}`
- `POST /api/v1/admin_dashboard_overview`
- `PUT /api/v1/admin_dashboard_overview/{id}`
- `POST /api/v1/admin_dashboard_overview/{id}/actions/{action}`
### معايير API
