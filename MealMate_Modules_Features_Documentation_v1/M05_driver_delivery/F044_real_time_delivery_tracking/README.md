...
## الشرح المختصر
ميزة **التتبع اللحظي** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/real_time_delivery_tracking`
- `GET /api/v1/real_time_delivery_tracking/{id}`
- `POST /api/v1/real_time_delivery_tracking`
- `PUT /api/v1/real_time_delivery_tracking/{id}`
- `POST /api/v1/real_time_delivery_tracking/{id}/actions/{action}`
### معايير API
