...
## الشرح المختصر
ميزة **إحصائيات وأداء السائق** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/driver_performance_statistics`
- `GET /api/v1/driver_performance_statistics/{id}`
- `POST /api/v1/driver_performance_statistics`
- `PUT /api/v1/driver_performance_statistics/{id}`
- `POST /api/v1/driver_performance_statistics/{id}/actions/{action}`
### معايير API
