...
## الشرح المختصر
ميزة **الاتصال الآمن** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/safe_contact`
- `GET /api/v1/safe_contact/{id}`
- `POST /api/v1/safe_contact`
- `PUT /api/v1/safe_contact/{id}`
- `POST /api/v1/safe_contact/{id}/actions/{action}`
### معايير API
