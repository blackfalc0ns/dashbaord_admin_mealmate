...
## الشرح المختصر
ميزة **تعيين الطلب للسائق** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/driver_order_assignment`
- `GET /api/v1/driver_order_assignment/{id}`
- `POST /api/v1/driver_order_assignment`
- `PUT /api/v1/driver_order_assignment/{id}`
- `POST /api/v1/driver_order_assignment/{id}/actions/{action}`
### معايير API
