...
## الشرح المختصر
ميزة **المحاولة الثانية** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/second_delivery_attempt`
- `GET /api/v1/second_delivery_attempt/{id}`
- `POST /api/v1/second_delivery_attempt`
- `PUT /api/v1/second_delivery_attempt/{id}`
- `POST /api/v1/second_delivery_attempt/{id}/actions/{action}`
### معايير API
