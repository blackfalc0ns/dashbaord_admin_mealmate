...
## الشرح المختصر
ميزة **تقييم السائق** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/driver_rating`
- `GET /api/v1/driver_rating/{id}`
- `POST /api/v1/driver_rating`
- `PUT /api/v1/driver_rating/{id}`
- `POST /api/v1/driver_rating/{id}/actions/{action}`
### معايير API
