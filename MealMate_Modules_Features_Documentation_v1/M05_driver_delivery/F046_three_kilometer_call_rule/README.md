# F046 — قاعدة الاتصال عند 3 كم

## Three-Kilometer Call Rule
...
## الشرح المختصر
ميزة **قاعدة الاتصال عند 3 كم** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- **قاعدة خاصة:** لا اتصال قبل 3 كم.
- **قاعدة خاصة:** القناة تخفي الرقم.
- **قاعدة خاصة:** الإظهار الحقيقي بعد فشل محاولتين وموافقة.
...
### APIs
- `GET /api/v1/three_kilometer_call_rule`
- `GET /api/v1/three_kilometer_call_rule/{id}`
- `POST /api/v1/three_kilometer_call_rule`
- `PUT /api/v1/three_kilometer_call_rule/{id}`
- `POST /api/v1/three_kilometer_call_rule/{id}/actions/{action}`
### معايير API
