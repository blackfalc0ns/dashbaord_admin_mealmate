...
## الشرح المختصر
ميزة **تأكيد التسليم بالمسح** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/delivery_confirmation_scan`
- `GET /api/v1/delivery_confirmation_scan/{id}`
- `POST /api/v1/delivery_confirmation_scan`
- `PUT /api/v1/delivery_confirmation_scan/{id}`
- `POST /api/v1/delivery_confirmation_scan/{id}/actions/{action}`
### معايير API
