...
## الشرح المختصر
ميزة **حالة Hold** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/delivery_hold`
- `GET /api/v1/delivery_hold/{id}`
- `POST /api/v1/delivery_hold`
- `PUT /api/v1/delivery_hold/{id}`
- `POST /api/v1/delivery_hold/{id}/actions/{action}`
### معايير API
