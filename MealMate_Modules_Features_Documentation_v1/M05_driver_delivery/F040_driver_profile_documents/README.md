...
## الشرح المختصر
ميزة **ملف السائق ووثائقه** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/driver_profile_documents`
- `GET /api/v1/driver_profile_documents/{id}`
- `POST /api/v1/driver_profile_documents`
- `PUT /api/v1/driver_profile_documents/{id}`
- `POST /api/v1/driver_profile_documents/{id}/actions/{action}`
### معايير API
