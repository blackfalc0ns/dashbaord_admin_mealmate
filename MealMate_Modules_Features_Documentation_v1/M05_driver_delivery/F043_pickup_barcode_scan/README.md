# F043 — مسح الباركود عند الاستلام
...
## الشرح المختصر
ميزة **مسح الباركود عند الاستلام** جزء من **السائق والتوصيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/pickup_barcode_scan`
- `GET /api/v1/pickup_barcode_scan/{id}`
- `POST /api/v1/pickup_barcode_scan`
- `PUT /api/v1/pickup_barcode_scan/{id}`
- `POST /api/v1/pickup_barcode_scan/{id}/actions/{action}`
### معايير API
