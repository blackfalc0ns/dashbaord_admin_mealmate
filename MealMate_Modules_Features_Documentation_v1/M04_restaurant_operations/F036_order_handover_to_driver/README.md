# F036 — تسليم الطلب للسائق

## Order Handover to Driver
...
## الشرح المختصر
ميزة **تسليم الطلب للسائق** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/order_handover_to_driver`
- `GET /api/v1/order_handover_to_driver/{id}`
- `POST /api/v1/order_handover_to_driver`
- `PUT /api/v1/order_handover_to_driver/{id}`
- `POST /api/v1/order_handover_to_driver/{id}/actions/{action}`
### معايير API
