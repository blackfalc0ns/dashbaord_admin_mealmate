# F031 — الطاقة الاستيعابية اليومية
...
## الشرح المختصر
ميزة **الطاقة الاستيعابية اليومية** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/daily_capacity_management`
- `GET /api/v1/daily_capacity_management/{id}`
- `POST /api/v1/daily_capacity_management`
- `PUT /api/v1/daily_capacity_management/{id}`
- `POST /api/v1/daily_capacity_management/{id}/actions/{action}`
### معايير API
