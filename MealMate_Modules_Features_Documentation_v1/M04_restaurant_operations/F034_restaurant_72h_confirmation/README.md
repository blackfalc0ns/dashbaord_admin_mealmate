# F034 — تأكيد طلبات نافذة 72 ساعة

## Restaurant 72h Confirmation
...
## الشرح المختصر
ميزة **تأكيد طلبات نافذة 72 ساعة** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_72h_confirmation`
- `GET /api/v1/restaurant_72h_confirmation/{id}`
- `POST /api/v1/restaurant_72h_confirmation`
- `PUT /api/v1/restaurant_72h_confirmation/{id}`
- `POST /api/v1/restaurant_72h_confirmation/{id}/actions/{action}`
### معايير API
