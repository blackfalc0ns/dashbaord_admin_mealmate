...
## الشرح المختصر
ميزة **إدارة سائقي المطعم** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_drivers_management`
- `GET /api/v1/restaurant_drivers_management/{id}`
- `POST /api/v1/restaurant_drivers_management`
- `PUT /api/v1/restaurant_drivers_management/{id}`
- `POST /api/v1/restaurant_drivers_management/{id}/actions/{action}`
### معايير API
