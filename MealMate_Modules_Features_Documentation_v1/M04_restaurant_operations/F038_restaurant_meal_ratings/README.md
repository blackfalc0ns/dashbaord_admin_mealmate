# F038 — تقييم المطعم والوجبة

## Restaurant & Meal Ratings
...
## الشرح المختصر
ميزة **تقييم المطعم والوجبة** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_meal_ratings`
- `GET /api/v1/restaurant_meal_ratings/{id}`
- `POST /api/v1/restaurant_meal_ratings`
- `PUT /api/v1/restaurant_meal_ratings/{id}`
- `POST /api/v1/restaurant_meal_ratings/{id}/actions/{action}`
### معايير API
