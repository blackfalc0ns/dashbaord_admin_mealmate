...
## الشرح المختصر
ميزة **إنهاء تعاقد المطعم** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_contract_termination`
- `GET /api/v1/restaurant_contract_termination/{id}`
- `POST /api/v1/restaurant_contract_termination`
- `PUT /api/v1/restaurant_contract_termination/{id}`
- `POST /api/v1/restaurant_contract_termination/{id}/actions/{action}`
### معايير API
