# F029 — إدارة أسعار المطعم

## Restaurant Price Management
...
## الشرح المختصر
ميزة **إدارة أسعار المطعم** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_price_management`
- `GET /api/v1/restaurant_price_management/{id}`
- `POST /api/v1/restaurant_price_management`
- `PUT /api/v1/restaurant_price_management/{id}`
- `POST /api/v1/restaurant_price_management/{id}/actions/{action}`
### معايير API
