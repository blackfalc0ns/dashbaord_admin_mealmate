# F030 — المناطق المخدومة

## Restaurant Service Regions
...
## الشرح المختصر
ميزة **المناطق المخدومة** جزء من **المطاعم والتشغيل**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_service_regions`
- `GET /api/v1/restaurant_service_regions/{id}`
- `POST /api/v1/restaurant_service_regions`
- `PUT /api/v1/restaurant_service_regions/{id}`
- `POST /api/v1/restaurant_service_regions/{id}/actions/{action}`
### معايير API
