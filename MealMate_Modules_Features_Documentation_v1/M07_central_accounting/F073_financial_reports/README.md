...
## الشرح المختصر
ميزة **التقارير المالية** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- `GET /api/v1/financial_reports/{id}`
- `POST /api/v1/financial_reports`
- `PUT /api/v1/financial_reports/{id}`
- `POST /api/v1/financial_reports/{id}/actions/{action}`
### معايير API
