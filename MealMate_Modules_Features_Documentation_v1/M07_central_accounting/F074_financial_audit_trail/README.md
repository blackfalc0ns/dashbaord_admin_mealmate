...
## الشرح المختصر
ميزة **سجل التدقيق المالي** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/financial_audit_trail`
- `GET /api/v1/financial_audit_trail/{id}`
- `POST /api/v1/financial_audit_trail`
- `PUT /api/v1/financial_audit_trail/{id}`
- `POST /api/v1/financial_audit_trail/{id}/actions/{action}`
### معايير API
