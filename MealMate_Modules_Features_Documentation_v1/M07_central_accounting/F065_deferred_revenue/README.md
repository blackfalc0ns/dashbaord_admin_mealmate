...
## الشرح المختصر
ميزة **الإيراد المؤجل** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- **قاعدة خاصة:** غير المستهلك التزام.
- **قاعدة خاصة:** الاعتراف يومي مع الاستهلاك.
- **قاعدة خاصة:** الإلغاء يعكس غير المكتسب.
...
### APIs
- `GET /api/v1/deferred_revenue`
- `GET /api/v1/deferred_revenue/{id}`
- `POST /api/v1/deferred_revenue`
- `PUT /api/v1/deferred_revenue/{id}`
- `POST /api/v1/deferred_revenue/{id}/actions/{action}`
### معايير API
