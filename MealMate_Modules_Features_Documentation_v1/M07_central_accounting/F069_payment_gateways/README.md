...
## الشرح المختصر
ميزة **بوابات الدفع** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/payment_gateways`
- `GET /api/v1/payment_gateways/{id}`
- `POST /api/v1/payment_gateways`
- `PUT /api/v1/payment_gateways/{id}`
- `POST /api/v1/payment_gateways/{id}/actions/{action}`
### معايير API
