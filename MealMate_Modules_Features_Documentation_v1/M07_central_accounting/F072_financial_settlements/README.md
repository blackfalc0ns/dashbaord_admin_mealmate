...
## الشرح المختصر
ميزة **التسويات المالية** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/financial_settlements`
- `GET /api/v1/financial_settlements/{id}`
- `POST /api/v1/financial_settlements`
- `PUT /api/v1/financial_settlements/{id}`
- `POST /api/v1/financial_settlements/{id}/actions/{action}`
### معايير API
