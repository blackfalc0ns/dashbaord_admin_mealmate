...
## الشرح المختصر
ميزة **مستحقات المؤثرين** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/influencer_payables`
- `GET /api/v1/influencer_payables/{id}`
- `POST /api/v1/influencer_payables`
- `PUT /api/v1/influencer_payables/{id}`
- `POST /api/v1/influencer_payables/{id}/actions/{action}`
### معايير API
