...
## الشرح المختصر
ميزة **شجرة الحسابات** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- `POST /api/v1/chart_of_accounts/{id}/actions/{action}`
### معايير API
