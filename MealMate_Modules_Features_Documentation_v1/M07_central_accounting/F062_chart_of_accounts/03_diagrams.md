...
```mermaid
flowchart TD
    Start(("Start F062 Chart of Accounts"))
    S1["استقبال حدث مالي."]
    S2["التحقق من المصدر."]
...
classDiagram
    ...
    User --> F062_Entity : creates/updates
    F062_Entity --> AuditLog : records
    F062_Entity --> NotificationLog : triggers
```
