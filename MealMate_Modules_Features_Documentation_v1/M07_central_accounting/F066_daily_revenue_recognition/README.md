...
## الشرح المختصر
ميزة **الاعتراف اليومي بالإيراد** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/daily_revenue_recognition`
- `GET /api/v1/daily_revenue_recognition/{id}`
- `POST /api/v1/daily_revenue_recognition`
- `PUT /api/v1/daily_revenue_recognition/{id}`
- `POST /api/v1/daily_revenue_recognition/{id}/actions/{action}`
### معايير API
