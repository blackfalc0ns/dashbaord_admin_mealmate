# F063 — الإعدادات المالية المركزية

## Central Financial Settings
...
## الشرح المختصر
ميزة **الإعدادات المالية المركزية** جزء من **النظام المالي والمحاسبي المركزي**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/central_financial_settings`
- `GET /api/v1/central_financial_settings/{id}`
- `POST /api/v1/central_financial_settings`
- `PUT /api/v1/central_financial_settings/{id}`
- `POST /api/v1/central_financial_settings/{id}/actions/{action}`
### معايير API
