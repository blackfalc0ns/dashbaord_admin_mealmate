...
## الشرح المختصر
ميزة **تذاكر الدعم** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
- `PUT /api/v1/support_tickets/{id}`
- `POST /api/v1/support_tickets/{id}/actions/{action}`
### معايير API
