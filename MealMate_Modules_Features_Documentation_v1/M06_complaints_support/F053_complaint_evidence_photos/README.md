...
## الشرح المختصر
ميزة **صور إثبات الشكوى** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/complaint_evidence_photos`
- `GET /api/v1/complaint_evidence_photos/{id}`
- `POST /api/v1/complaint_evidence_photos`
- `PUT /api/v1/complaint_evidence_photos/{id}`
- `POST /api/v1/complaint_evidence_photos/{id}/actions/{action}`
### معايير API
