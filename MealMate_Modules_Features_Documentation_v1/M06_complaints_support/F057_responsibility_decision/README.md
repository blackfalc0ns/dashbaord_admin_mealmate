...
## الشرح المختصر
ميزة **تحديد المسؤولية** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/responsibility_decision`
- `GET /api/v1/responsibility_decision/{id}`
- `POST /api/v1/responsibility_decision`
- `PUT /api/v1/responsibility_decision/{id}`
- `POST /api/v1/responsibility_decision/{id}/actions/{action}`
### معايير API
