# F059 — خصم قيمة البوكس من المطعم

## Restaurant Box Deduction
...
## الشرح المختصر
ميزة **خصم قيمة البوكس من المطعم** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_box_deduction`
- `GET /api/v1/restaurant_box_deduction/{id}`
- `POST /api/v1/restaurant_box_deduction`
- `PUT /api/v1/restaurant_box_deduction/{id}`
- `POST /api/v1/restaurant_box_deduction/{id}/actions/{action}`
### معايير API
