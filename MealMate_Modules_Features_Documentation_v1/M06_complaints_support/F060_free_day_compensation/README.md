# F060 — إضافة يوم مجاني

## Free Day Compensation
...
## الشرح المختصر
ميزة **إضافة يوم مجاني** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/free_day_compensation`
- `GET /api/v1/free_day_compensation/{id}`
- `POST /api/v1/free_day_compensation`
- `PUT /api/v1/free_day_compensation/{id}`
- `POST /api/v1/free_day_compensation/{id}/actions/{action}`
### معايير API
