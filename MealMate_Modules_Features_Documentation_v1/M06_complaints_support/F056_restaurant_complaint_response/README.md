# F056 — رد المطعم على الشكوى

## Restaurant Complaint Response
...
## الشرح المختصر
ميزة **رد المطعم على الشكوى** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/restaurant_complaint_response`
- `GET /api/v1/restaurant_complaint_response/{id}`
- `POST /api/v1/restaurant_complaint_response`
- `PUT /api/v1/restaurant_complaint_response/{id}`
- `POST /api/v1/restaurant_complaint_response/{id}/actions/{action}`
### معايير API
