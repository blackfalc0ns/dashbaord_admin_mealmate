# F054 — نقاط الضعف التفصيلية

## الميزة
**Complaint Classification**  
الميزة جزء من **M06 — الشكاوى والدعم**، ومجالها الأساسي: إنشاء الشكاوى، الأدلة، التصنيف، مراجعة الأدمن، رد المطعم، تحديد المسؤولية، التعويض، والخصومات.
