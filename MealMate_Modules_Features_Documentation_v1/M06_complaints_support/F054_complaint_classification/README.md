...
## الشرح المختصر
ميزة **تصنيف الشكوى** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/complaint_classification`
- `GET /api/v1/complaint_classification/{id}`
- `POST /api/v1/complaint_classification`
- `PUT /api/v1/complaint_classification/{id}`
- `POST /api/v1/complaint_classification/{id}/actions/{action}`
### معايير API
