...
## الشرح المختصر
ميزة **مراجعة الأدمن للشكوى** جزء من **الشكاوى والدعم**. توثق هذه الصفحة السلوك التجاري والتشغيلي والتقني المطلوب، وتربط الواجهة والـBackend وقاعدة البيانات والصلاحيات والإشعارات والأثر المالي في مصدر واحد.
...
### APIs
- `GET /api/v1/admin_complaint_review`
- `GET /api/v1/admin_complaint_review/{id}`
- `POST /api/v1/admin_complaint_review`
- `PUT /api/v1/admin_complaint_review/{id}`
- `POST /api/v1/admin_complaint_review/{id}/actions/{action}`
### معايير API
